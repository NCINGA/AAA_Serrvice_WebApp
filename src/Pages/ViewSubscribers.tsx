            ...
            <div className="card justify-content-center w-full h-full">
                ...
                <div style={{ marginTop: 100, justifyContent: 'center', marginLeft: "auto", marginRight: "auto" }} className={'absolute'}>
                    <DataTable style={{ width: "100%" }} value={data?.getSubscribersByPage?.content ?? []} tableStyle={{ minWidth: '50rem' }}>
                        ...
                        <Column field="createdDate" header="Created Time" body={loading && <Skeleton />} />
                        <Column field="updatedTime" header="Updated Time" body={loading && <Skeleton />} />
                ...
                {subscriberToDelete && (
                    <ConfirmDialog visible header="Confirm Deletion" message="Do you want to delete this subscriber?"
